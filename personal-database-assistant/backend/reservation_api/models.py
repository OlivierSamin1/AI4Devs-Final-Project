...
class HollydaysReservation(models.Model):
    ...
    """
    platform = models.ForeignKey(HollydaysPlatform, related_name='platform_reservations', blank=False, null=True, on_delete=models.CASCADE)
    asset = models.ForeignKey(Asset, related_name='reservations', on_delete=models.CASCADE, blank=True, null=True)
    ...
    def __str__(self):
        return f"{self.platform} - {self.reservation_number}"
