"""
Django settings for personal_db_assistant project.
"""
...
ROOT_URLCONF = 'personal_db_assistant.urls'
...
WSGI_APPLICATION = 'personal_db_assistant.wsgi.application'
...
# API Bridge settings
API_BRIDGE_URL = os.environ.get('API_BRIDGE_URL', 'http://api_bridge:5000')
