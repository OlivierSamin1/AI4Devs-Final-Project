...
**As a** backend developer,  
**I want to** establish a secure connection between the application server (RPI4) and database server (RPI3),  
**So that** the application can retrieve health data from the database.
...
**So that** API endpoints can efficiently retrieve data from the database.
...
**As a** backend developer,  
**I want to** create data models for health symptoms,  
**So that** the application can work with structured data.

**Acceptance Criteria:**
- Models include fields for symptom name, date, severity, and context
- Models include validation for data integrity
- Models support serialization to/from JSON
- Models map efficiently to database schema
