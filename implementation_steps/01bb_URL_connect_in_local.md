...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '192.168.1.X',  # Replace with your Raspberry Pi's IP address
...
2. Note the IP address (it will be something like `192.168.1.X`).
...
```
http://192.168.1.X:8000/your-endpoint/
```

Replace:
- `192.168.1.X` with your Raspberry Pi's IP address
- `8000` with the port your Django server is running on
- `your-endpoint` with the actual API endpoint path
...
curl -H "Authorization: Bearer your_access_token" \
  http://192.168.1.X:8000/your-protected-endpoint/
```

### Using a REST Client (like Postman)

1. Create a new request in Postman
2. Enter URL: `http://192.168.1.X:8000/your-endpoint/`
...
- Ensure token format is correct (including the "Bearer " prefix)
...
Replace `192.168.1.0/24` with your actual local network subnet.
...
curl http://192.168.1.X:8000/your-endpoint/
```
